  ...
  const footerLinks = [
    ...
    },
    {
      ...
      links: [
        ...
        {
          name: "Complain : +923007246696",
          path: "https://wa.me/923007246696",
        },
            ...
            <div className="flex space-x-4 mt-4 lg:hidden">
              ...
              >
                ...
                <svg
                  ...
                  aria-hidden="true"
                >
                  <path d="M10 15.5v-7l6 3.5-6 3.5zm12-3.5c0-2.5-.2-4.2-.6-5.4-.4-1.2-1.3-2.1-2.5-2.5C17.7 4 12 4 12 4s-5.7 0-6.9.1c-1.2.4-2.1 1.3-2.5 2.5C2.2 7.8 2 9.5 2 12s.2 4.2.6 5.4c.4 1.2 1.3 2.1 2.5 2.5C6.3 20 12 20 12 20s5.7 0 6.9-.1c1.2-.4 2.1-1.3 2.5-2.5.4-1.2.6-2.9.6-5.4z" />
                </svg>
              </a>
              ...
              >
                ...
                <svg
                  ...
                  aria-hidden="true"
                >
                  <path d="M12.75 2a6.75 6.75 0 006.75 6.75v2.25a9 9 0 01-6.75-3.26v7.01a5.25 5.25 0 11-5.25-5.25h1.5a3.75 3.75 0 103.75 3.75V2h1.25z" />
                </svg>
              </a>
            </div>
          </div>
