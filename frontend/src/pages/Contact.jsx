  ...
  return (
    <div className="bg-gray-50">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        1.064-.218 1.791-.465 2.427a4.902 4.902 
        0 01-1.153 1.772 4.902 4.902 0 
        ...
        2h.63zM12 6.865a5.135 5.135 0 110 
        ...
        1.2 0 110 2.4 1.2 1.2 0 010-2.4z"
                ...
                {/* Twitter / X */}
                <a
                  href="https://x.com/RaeesMalls?t=GUKlHdeBWzBWqejDe0PnXQ&s=09"
                  target="blank"
                  className="text-gray-600 hover:text-red-600 transition-colors"
                >
      ...
      17.52h1.833L7.084 4.126H5.117z"
                ...
                >
                  ...
                  >
                    <path
                      d="M12.75 2.25c.414 0 .75.336.75.75v1.5a6.75 
      6.75 0 006.75 6.75h.75a.75.75 0 01.75.75v2.25a.75.75 
      0 01-.75.75h-.75a9.75 9.75 0 01-6-2.073v7.323a6.75 
      6.75 0 11-6-6.69.75.75 0 01.75.75v2.19a.75.75 
      0 01-.684.745A3.751 3.751 0 108.25 
      18.75V3a.75.75 0 01.75-.75h3.75z"
                    />
                  </svg>
                </a>
                ...
                >
                  ...
                  >
                    <path
                      d="M21.8 8s-.2-1.5-.8-2.2c-.7-.8-1.6-.8-2-1C16.7 
      4.5 12 4.5 12 4.5h0s-4.7 0-7 
      .3c-.4.2-1.3.2-2 1C2.2 6.5 
      2 8 2 8S1.8 9.7 1.8 11.5v1c0 
      1.8.2 3.5.2 3.5s.2 1.5.8 
      2.2c.7.8 1.6.8 2 1 2.3.3 
      7 .3 7 .3s4.7 0 7-.3c.4-.2 
      1.3-.2 2-1 .6-.7.8-2.2.8-2.2s.2-1.7.2-3.5v-1c0-1.8-.2-3.5-.2-3.5zM10 
      15V9l5.5 3-5.5 3z"
                    />
                  </svg>
                </a>
